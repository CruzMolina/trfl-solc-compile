...
function setupMethods(soljson) {
  ...
  var runWithCallbacks = function (callbacks, compile, args) {
    ...
    var removeFunction =
      soljson.removeFunction || soljson.Runtime.removeFunction;
  ...
  if ("_compileJSONMulti" in soljson) {
    ...
    compileJSONMulti = soljson.cwrap("compileJSONMulti", "string", [
      "string",
      "number",
    ]);
  }
  ...
  if ("_compileJSONCallback" in soljson) {
    ...
    var compileInternal = soljson.cwrap("compileJSONCallback", "string", [
      "string",
      "number",
      "number",
    ]);
  ...
  if ("_compileStandard" in soljson) {
    ...
    var compileStandardInternal = soljson.cwrap("compileStandard", "string", [
      "string",
      "number",
    ]);
  ...
  if ("_solidity_compile" in soljson) {
    ...
    if (isVersion6) {
      ...
      solidityCompile = soljson.cwrap("solidity_compile", "string", [
        "string",
        "number",
        "number",
      ]);
  ...
  return {
    ...
    loadRemoteVersion: function (versionString, cb) {
      ...
      var url =
        "https://ethereum.github.io/solc-bin/bin/soljson-" +
        versionString +
        ".js";
      https
